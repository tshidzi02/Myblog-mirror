...
export default function App() {
  ...
  function handleAddPost(newPost) {
    const normalized = {
      ...newPost,
      tags: Array.isArray(newPost.tags) ? newPost.tags : (newPost.tag ? [newPost.tag] : []),
    };
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/blog/new" element={<CreatePost onAddPost={handleAddPost} />} />
        <Route
  path="/blog"
  element={<BlogPost posts={posts} onDeletePost={handleDeletePost} />}
/>
